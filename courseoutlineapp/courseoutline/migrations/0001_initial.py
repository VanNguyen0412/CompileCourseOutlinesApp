    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Quản trị viên'), ('lecturer', 'Giảng viên'), ('student', 'Sinh viên')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lessons', models.ManyToManyField(to='courseoutline.lesson')),
                ('outline', models.ManyToManyField(to='courseoutline.outline')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
